...
C(1).B(1).a=a_crack;
C(1).B(1).R_c=[-D/(4*Length_unit) 0 0];
C(1).B(1).phi=pi/2;
C(1).B(2).a=a_crack/2;
C(1).B(2).R_c=[0.15*(D/(2*Length_unit)) (D/(3*Length_unit)) 0];
C(1).B(2).phi=pi/4;
C(2).B(1).a=a_crack/2;
C(2).B(1).R_c=[D/(4*Length_unit) 0 0];
C(2).B(1).phi=pi/2;
C(2).B(2).a=a_crack/4;
C(2).B(2).R_c=[0.15*(D/(2*Length_unit)) (D/(3*Length_unit)) 0];
C(2).B(2).phi=pi/6;
