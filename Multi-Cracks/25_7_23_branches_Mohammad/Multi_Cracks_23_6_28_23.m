...
close
    ...
    max_iterations=iter_max*C(i_q).B(k_q).n_d;
        ...
        if C(i_q).B(k_q).K(1) > K_IC && C(i_q).B(k_q).K(2) > K_IC
            ...
            C(i_q).B(k_q).D(1).R_p = C(i_q).B(k_q).D(1).R_p + 50*delr*C(i_q).B(k_q).e_p;
            delr = C(i_q).B(k_q).d*t(i_q,2*C(i_q).B(k_q).n_d,k_q)/(n_steps*max(sig_amp,t_max));
            C(i_q).B(k_q).D(2*C(i_q).B(k_q).n_d).R_p = C(i_q).B(k_q).D(2*C(i_q).B(k_q).n_d).R_p +50*delr*C(i_q).B(k_q).e_p;
        end
end
